...
import static graycygnus.mygraphics.R.drawable.fire;
...
public class Negro {
    ...
    private float vertices[] = {
            ...
            //Ventana
            //Frente
            -1.0f, -1.0f, 1.0001f, //Vertex 0
            0.0f, -1.0f, 1.0001f,  //v1
            -1.0f, 0.5f, 1.0001f,  //v2
            0.0f, 0.5f, 1.0001f,   //v3
    };
    ...
    public void loadGLTexture(GL10 gl, Context context) {
        ...
        InputStream is = context.getResources().openRawResource(+fire);
        Bitmap bitmap = null;
        try {
